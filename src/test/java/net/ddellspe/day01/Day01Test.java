...
public class Day01Test {
  ...
  public void providedInputTestPart1() {
    assertEquals(7L, Day01.part1("example.txt"));
  }

  @Test
  public void providedInputTestPart1Optimized() {
    assertEquals(7L, Day01.part1Optimized("example.txt"));
  }
  ...
  public void providedInputTestPart2() {
    assertEquals(5L, Day01.part2("example.txt"));
  }

  @Test
  public void providedInputTestPart2Optimized() {
    assertEquals(5L, Day01.part2Optimized("example.txt"));
  }
